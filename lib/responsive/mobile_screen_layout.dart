...
import 'package:estore/utils/global_veriables.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: CupertinoTabBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.favorite_border_outlined, color: _page==3? primaryColor : secondaryColor), label: '', backgroundColor: primaryColor),
